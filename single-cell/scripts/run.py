#!/usr/bin/env python3
"""
ToolUniverse workflow: tooluniverse-single-cell

CLI wrapper for the single-cell / expression matrix analysis agentic workflow.
See: https://github.com/mims-harvard/ToolUniverse/tree/main/skills/tooluniverse-single-cell

Usage:
    python3 run.py --query "Analyze cell type composition in my scRNA-seq data"
...
WORKFLOW = "tooluniverse-single-cell"
...
def main():
    parser = argparse.ArgumentParser(
        description=f"Run the ToolUniverse '{WORKFLOW}' single-cell analysis workflow.",
    )
