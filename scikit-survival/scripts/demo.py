...
Basic demonstration script showing how to use scikit-survival.
...
def demonstrate():
    """Demonstrate basic scikit-survival usage."""
    return {
...
def main():
    parser = argparse.ArgumentParser(description="scikit-survival demonstration")
    parser.add_argument(
