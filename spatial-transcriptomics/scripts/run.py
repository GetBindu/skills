#!/usr/bin/env python3
"""
ToolUniverse workflow: tooluniverse-spatial-transcriptomics

CLI wrapper for the spatial transcriptomics analysis agentic workflow.
See: https://github.com/mims-harvard/ToolUniverse/tree/main/skills/tooluniverse-spatial-transcriptomics

Usage:
    python3 run.py --query "Map gene expression in 10x Visium breast cancer tissue"
...
WORKFLOW = "tooluniverse-spatial-transcriptomics"
...
def main():
    parser = argparse.ArgumentParser(
        description=f"Run the ToolUniverse '{WORKFLOW}' spatial transcriptomics workflow.",
    )
