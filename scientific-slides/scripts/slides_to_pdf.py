...
def combine_images_to_pdf(image_paths: List[Path], output_path: Path, dpi: int = 150, verbose: bool = False) -> bool:
    """
    ...
    try:
        ...
        # Save to PDF
        first_image.save(output_path, "PDF", resolution=dpi, save_all=True, append_images=remaining_images)
