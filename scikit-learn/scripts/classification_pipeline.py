...
def train_and_evaluate_model(X, y, numeric_features, categorical_features, test_size=0.2, random_state=42):
    """
    ...
    grid_search = GridSearchCV(best_model, param_grid, cv=5, scoring="accuracy", n_jobs=-1, verbose=0)
...
if __name__ == "__main__":
    ...
    results = train_and_evaluate_model(X, y, numeric_features, categorical_features, test_size=0.2, random_state=42)
