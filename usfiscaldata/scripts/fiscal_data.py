...
class FiscalDataQueryEngine:
    ...
    def execute_query(self, endpoint: str, params: Optional[Dict] = None, 
                      format_output: str = "json") -> Dict:
        """
...
Examples:
  ...
  python fiscal_data.py --endpoint v1/accounting/mts/mts_table_1 --schema
    ...
    parser.add_argument("--endpoint", type=str, 
                       help="API endpoint (e.g., v1/accounting/mts/mts_table_1)")
    parser.add_argument("--fields", type=str,
                       help="Comma-separated field list (e.g., 'record_date,amount')")
    parser.add_argument("--filter", type=str,
                       help="Filter expression (e.g., 'record_date:gte:2023-01-01')")
    parser.add_argument("--sort", type=str,
                       help="Sort field (use - for descending, e.g., '-record_date')")
    parser.add_argument("--page-size", type=int, dest="page_size",
                       help="Results per page (1-10000)")
    parser.add_argument("--page-number", type=int, dest="page_number",
                       help="Page number (>=1)")
    ...
    parser.add_argument("--discover", action="store_true",
                       help="Discover all available tables")
    parser.add_argument("--schema", action="store_true",
                       help="Get schema for specified endpoint")
    parser.add_argument("--output-format", type=str, choices=["json", "summary"], default="json",
                       dest="output_format",
